import type { Parsed, Row } from './types.ts'
...
export interface DataSet {
   ...
   */
  cell(index: number, key: string): string | number | boolean | null | undefined
  /**
...
> {
  ...
  public abstract cast(value: U): T | null | undefined
  ...
  public get values(): Array<T> {
    return (this.raw().map((value) => this.cast(value)) as Array<T>)
  }
...
class NullColumn extends Column<boolean> {
  ...
  public override raw(): Array<boolean> {
    return ((new Array(this.parent.n)).fill(null))
  }
  public override get values(): Array<boolean> {
    return ((new Array(this.parent.n)).fill(null))
  }
  public cast(_: boolean): null {
    return null
  }
...
class StrColumn extends Column<string> {
  public cast(value: string): string | null {
...
class FacColumn extends Column<number, string> {
  ...
  public cast(value: number): string | null | undefined {
...
class NumColumn extends Column<number> {
  ...
  public cast(value: number): number | null {
    return (this.ismissing(value) ? null : value)
  }
  ...
  public override ismissing(value: number): boolean {
    return (
...
class View implements DataSet {
  ...
  constructor(parent: Savvy, indices: Array<number>, keys: Array<string>) {
    ...
    this.indices = indices?.slice() ??
      new Array(parent.n).fill(0).map((_, idx) => idx)
  ...
  public cell(index: number, key: string): string | number | boolean | null | undefined {
        ...
        if (levels.get(header.name)?.size) {
          ...
          this.fields.set(
            ...
            new NumColumn(
              ...
              header.name,
              new Set(header.missing.codes),
              header.missing.range as [number, number],
              parsed.internal.display[j].type,
            ),
          )
        }
